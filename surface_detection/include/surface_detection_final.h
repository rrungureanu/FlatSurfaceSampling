...
#ifndef SURFACE_DETECTION_SURFACE_DETECTION_FINAL_H
#define SURFACE_DETECTION_SURFACE_DETECTION_FINAL_H
...
public:
    ...
    void nullifyIO(int pin);
};

#endif //SURFACE_DETECTION_SURFACE_DETECTION_FINAL_H
